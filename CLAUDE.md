...
- `TALLY_SYSTEM.md` — Design doc and authored content for the tally/ledger system. All verdict text is authored Saunders voice — pull verbatim, never paraphrase or generate.